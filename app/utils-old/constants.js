var C = {
  ...
  //api_gateway isn't running
  INTERNALSERVER_HTTP_CODES: [500],

  //api_gateway subsystem like database isn't working
  ...
  /* Admin infra structure ninja and sensei nodes status, storage type and lincense status*/
  ADMIN: {
    STATUS: {
