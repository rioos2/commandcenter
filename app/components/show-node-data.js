...
export default Ember.Component.extend({
  ...
  buildTabName: function(i) {
    return "tab_" + this.get('model').id + "_" + i;
  },

  tabname_1: function() {
    return this.buildTabName("1");
  }.property('model'),

  tabname_2: function() {
    return this.buildTabName("2");
  }.property('model'),

  tabname_3: function() {
    return this.buildTabName("3");
  }.property('model'),

  tabname_4: function() {
    return this.buildTabName("4");
  }.property('model'),

  tabnamewithhash_1: function() {
    return "#" + this.buildTabName("1");
  }.property('model'),

  tabnamewithhash_2: function() {
    return "#" + this.buildTabName("2");
  }.property('model'),

  tabnamewithhash_3: function() {
    return "#" + this.buildTabName("3");
  }.property('model'),

  tabnamewithhash_4: function() {
    return "#" + this.buildTabName("4");
  }.property('model'),

  guageBoxClass: function() {
    return "gauge_box" + this.get('model').id + " gauge_common gauge_y";
  }.property('model'),

  guageSvgClass: function() {
    return "gauge" + this.get('model').id + " gauge_svg";
  }.property('model'),
  ...
  initializeChart: Ember.on('didInsertElement', function() {
    var id = this.get('model').id;
    this.$(".gauge_box" + id).append('<div class = "contant"><canvas id = "canvas_back_' + id + '" width = "177" height = "138" class = "canvas_back"></canvas></div><div class="contant_gauge contant_' + id + '"><div class= "row_1"></div><div class= "row_2"></div><div class= "row_3"></div><div class= "row_4"></div><div class= "row_5"></div></div>');
    this.$(".gauge_box" + id).css("text-align", "left");
    ...
    d3.select(".gauge" + id).call(this.get('chart')[id]);
  ...
  draw: function() {
    const self = this;
    self.$('.contant_' + self.get('model').id + ' .element').css("opacity", "0");
    var counter = Math.floor(self.get('model').counter/2.85);
    for (var i = 0; i < counter; i++) {
      self.$(".contant_" + self.get('model').id + " img[value='" + i + "']").css("opacity", "1");
    }
  },
