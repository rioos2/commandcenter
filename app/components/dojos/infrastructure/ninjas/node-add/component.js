...
export default Component.extend(DefaultHeaders, {
  ...
  noteForRangeSubnet: function() {
    return htmlSafe(get(this, 'intl').t('dojos.infrastructure.ninjas.install.subnet.range.note'));
  }.property('model'),
  ...
  subnetAdvancePlaceHolder: function() {
    return get(this, 'intl').t('dojos.infrastructure.ninjas.install.ipblock.placeholder');
  }.property('model'),
