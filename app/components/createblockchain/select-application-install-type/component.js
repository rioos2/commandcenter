...
export default Component.extend({
  ...
  groupingVms() {
    ...
    planfactory.forEach((plan) => {
      if (plan.category.toLowerCase() === C.CATEGORIES.BLOCKCHAIN_TEMPLATE && plan.status.phase.toLowerCase() === C.PHASE.READY ) {
    ...
    uniqueVmGroup.forEach((vm) => {
      ...
      planfactory.forEach((plan) => {
        if (plan.object_meta.name === vm && plan.status.phase.toLowerCase() === C.PHASE.READY && plan.category.toLowerCase() === C.CATEGORIES.BLOCKCHAIN_TEMPLATE ) {
