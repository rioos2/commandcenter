...
export default Component.extend(DefaultHeaders, {
  ...
  ram: function() {
    return this.gibFormater(this.get('resources.memory').toString()) + get(this, 'intl').t('launcherPage.resource.capacity.storage.select.suffix');
  }.property('resources.memory'),

  storage: function() {
    return this.gibFormater(this.get('resources.storage').toString()) + get(this, 'intl').t('launcherPage.resource.capacity.ram.titleUpcase');
