...
C.SEARCH_ACCESSOR = [C.FILTERS.SELECT_OS_ACCESSOR, C.FILTERS.SELECT_LOCATION_ACCESSOR, C.FILTERS.SELECT_DB_ACCESSOR, C.FILTERS.SELECT_STATUS_ACCESSOR, C.FILTERS.SELECT_NETWORK_ACCESSOR],
...
C.FILTERS.QUERYPARM_TO_ACCESSOR_HASH = [
  ...
  { selector: C.FILTERS.QUERY_PARAM_SEARCH, accessor: C.FILTERS.SEARCH_ACCESSOR},
];
