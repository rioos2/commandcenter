/* eslint-disable */
function renderGlobeChart(stackfactory, locationList, notifications) {
  var attrs = {
    width:     350,
    height:    350,
    container: '#rio-globe',
  };
  var locationlist = locationList.features;
  var currpoint = [];
  ...
  d3.json('world-continents.json', (error, world) => {
    ...
    svg.append('g').selectAll('path.cities').data(locationList.features)
      .enter()
      .append('path')
      .attr('class', 'cities')
      .attr('id', (d) => {
